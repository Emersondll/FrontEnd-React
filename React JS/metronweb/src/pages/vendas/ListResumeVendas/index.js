      ...
      <div className="divResumeSearch">
        <div className="divResumeSearchHead">
          ...
          <div className="divCenter">
            ...
            <Input
              value={this.state.SomaVenda}
              placeholder="Soma Venda"
              className="SomaVenda"
              disabled
            />
            <Input
              value= {this.state.SomaRecebimento}
              placeholder="Soma Recebimento"
              className="SomaRecebimento"
              disabled
            />
            <Input
               value={this.state.SomaVenda - this.state.SomaRecebimento}
          ...
          <div className="divResumeSearchPagamentos">
            <form className="formFilter" onSubmit={this.handleSubmitReceiver}>
              <TextField
                id="filter"
                label="ID CLiente"
                type="search"
